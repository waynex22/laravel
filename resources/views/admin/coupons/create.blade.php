    ...
    <div class="container-fluid py-1 px-0 mb-2">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                ...
                <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Tạo mã khuyến mãi</li>
            </ol>
            <h1 class="font-weight-bolder mb-0 title-font title-categories">Tạo mã khuyến mãi</h1>
        </nav>
    ...
    <div>
        <form action="{{route('coupons.store')}}" method="post">
            ...
            <div class="input-group input-group-static mb-4 mt-3">
                ...
                <input name="name" type="text" value="{{old('name')}}" class="form-control" style="text-transform: uppercase"/>
                @error('name')
            ...
            <div class="input-group input-group-static mb-4">
                ...
                <input name="expery_date" type="date" value="{{old('expery_date')}}" class="form-control"/>
                @error('expery_date')
                    <span class="text-danger">{{$message}}</span>
                @enderror
            </div>
